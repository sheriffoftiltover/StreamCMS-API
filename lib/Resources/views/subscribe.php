...
<section class="container">
    ...
    <?php if (Session::hasRole(UserRole::USER)): ?>
        <div id="giftSubscriptionSelect" class="alert alert-info" style="text-align: center;">
            ...
            <button class="btn btn-primary" data-toggle="modal" data-target="#userSearchModal">Yes, gift a subscription
                <span class="glyphicon glyphicon-gift"></span></button>
        </div>
        ...
        <div id="giftSubscriptionConfirm" class="alert alert-info hidden" style="text-align: center;">
            ...
            <button class="btn btn-primary" id="selectGiftSubscription" data-toggle="modal"
                    data-target="#userSearchModal">Change <span class="glyphicon glyphicon-gift"></span></button>
...
<div class="modal fade" id="userSearchModal" tabindex="-1" role="dialog" aria-labelledby="userSearchModalLabel"
     aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form id="userSearchForm">
                    ...
                    <div id="usrFrmGrp" class="form-group">
                        ...
                        <input tabindex="1" type="text" id="userSearchInput" class="form-control"
                               placeholder="E.g. Destiny"/>
                        <label class="error hidden"></label>
                    </div>

                    <button tabindex="4" type="button" class="btn btn-default" data-dismiss="modal"
                            id="userSearchCancel">Cancel
                    </button>
                    <button tabindex="3" type="submit" class="btn btn-primary" id="userSearchSelect"
                            data-loading-text="Checking user...">Select
                    </button>
                </form>
            </div>
        </div>
