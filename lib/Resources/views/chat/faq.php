...
<section class="container">
    <h1 class="title">
        <small class="subtle pull-right" style="font-size:14px; margin-top:20px;">Last
            update: <?= Date::getDateTime(filemtime(__FILE__))->format(Date::STRING_FORMAT) ?></small>
    ...
    <p>
        ...
        chat is echoed to Rizon IRC at <a href="http://qchat.rizon.net/?channels=#destinyecho">#destinyecho</a>.
        Forwarding of IRC chat to DestinyChat is available (see the topic of the IRC channel for details).
    </p>
