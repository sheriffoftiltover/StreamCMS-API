                ...
                <div class="tools">
                    ...
                    <?php if (Session::hasFeature(UserFeature::MODERATOR) || Session::hasFeature(UserFeature::ADMIN)): ?>
                        ...
                        <form id="user-ban-form">
                            ...
                            <div class="form-group">
                                <select id="banTimeLength" class="select form-control input-sm" style="width:150px;"
                                        onchange="$('#banReason').focus();">
                                    <option value="0">Length of time</option>
                            ...
                            <div class="form-group">
                                <input type="text" class="input form-control input-sm" id="banReason"
                ...
                <ul class="unstyled">
                    ...
                    <li>
                        <label class="text" title="Your custom list of words that will make messages highlight"
                            ...
                            <input name="customhighlight" type="text" class="form-control input-sm"
                                   placeholder="Separated using a comma (,)"/>
                        </label>
                    </li>
                    <li>
