            ...
            <form class="onceoff" action="/subscription/create" method="post">
                ...
                <?php if (!empty($model->currentSubscription)): ?>
                    ...
                    <div class="ds-block clearfix">
                        ...
                        <div class="subscriptions pull-left"
                             style="border-right:1px dashed #222; padding-right: 15px; margin-right: 15px;">
                            <div class="subscription-tier clearfix">
                                <div class="subscription" style="width: auto;">
                                    ...
                                    <div>
                                        <span class="sub-amount">$<?= $model->currentSubscriptionType['amount'] ?></span>
                                        (<?= $model->currentSubscriptionType['billingFrequency'] ?> <?= strtolower($model->currentSubscriptionType['billingPeriod']) ?>
                                        )
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="subscriptions pull-left">
                            <div class="subscription-tier clearfix">
                                <div class="subscription" style="width: auto;">
                                    ...
                                    <div><span class="sub-amount">$<?= $model->subscriptionType['amount'] ?></span>
                    ...
                    <div class="subscription-tier ds-block">
                        <div class="subscription">
                            ...
                            <?php if (!empty($model->gift)): ?>
                                <p><span class="glyphicon glyphicon-gift"></span> You are gifting this to <span
                                            class="label label-danger"><?= Tpl::out($model->gift) ?></span></p>
                            <?php endif; ?>
                ...
                <div class="ds-block">
                    <label class="checkbox">
                        <input type="checkbox" name="renew" value="1" checked="checked"/> Automatically renew this
                        subscription
                    </label>
                </div>
                ...
                <div class="ds-block">
                    <p>
                        <span>By clicking the 'Pay subscription' button below, you are confirming that this purchase is what you wanted and that you have read the <a
                                    href="/help/agreement">user agreement</a>.</span>
                        <br/><a href="#" onclick="$(this).hide().parent().next().show(); return false;">Planning to use
                            eChecks?</a>
                    </p>
                    <p style="display: none;">
                        <span class="label label-warning">NOTE:</span> Those who choose to use the &quot;eCheck&quot; as
                        a payment type, will not receive their subscription
                ...
                <div class="ds-block">
                    <label>
                        ...
                        <input type="text" name="sub-message" autocomplete="off" maxlength="250" class="form-control"
                               placeholder=""/>
                    </label>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg"><span
                                class="glyphicon glyphicon-shopping-cart"></span> Pay subscription
                    </button>
