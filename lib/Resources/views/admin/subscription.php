        ...
        <form action="<?= $url ?>" method="post">
            ...
            <div class="ds-block">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" class="form-control" name="createdDate" id="inputStarttimestamp"
                               value="<?= Tpl::out($model->subscription['createdDate']) ?>" placeholder="Y-m-d H:i:s">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" class="form-control" name="endDate" id="inputEndtimestamp"
                               value="<?= Tpl::out($model->subscription['endDate']) ?>" placeholder="Y-m-d H:i:s">
                        <span class="help-block">time specificed in UCT</span>
                    </div>
                </div>
