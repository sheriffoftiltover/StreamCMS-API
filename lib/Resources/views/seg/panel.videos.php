    ...
    <div class="content content-dark content-split clearfix">
        <div id="youtube" class="stream">
            <h3 class="title clearfix">
                <span>Videos</span> <a
                        href="http://www.youtube.com/user/<?= Config::$a['youtube']['user'] ?>/videos?view=0"
                        class="youtube-title">youtube.com</a>
            </h3>
            <ul class="thumbnails">
        ...
        <div id="broadcasts" class="stream">
            <h3 class="title clearfix">
                <span>Broadcasts</span> <a
                        href="http://www.twitch.tv/<?= Config::$a['twitch']['user'] ?>/profile/pastBroadcasts"
                        class="twitch-title">twitch.tv</a>
            </h3>
            <ul class="thumbnails">
                    ...
                    <? foreach ($model->broadcasts['videos'] as $broadcast):?>
                        ...
                        <li>
                            <div class="thumbnail" data-placement="bottom" data-toggle="tooltip" title="<?= $time ?>">
                                <a href="<?= $broadcast['url'] ?>"> <img alt="<?= $time ?>"
                                                                         src="<?= Config::cdn() ?>/web/img/320x240.gif"
                                                                         data-src="<?= $broadcast['preview'] ?>"/></a>
                            </div>
                        </li>
                    <? endforeach; ?>
                <? else:?>
