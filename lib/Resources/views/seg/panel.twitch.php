...
?>
<section id="twitchpanel" class="container split-view" data-youtube-user="<?= Config::$a['youtube']['user'] ?>"
         data-youtube-playlist="<?= Config::$a['youtube']['playlistId'] ?>"
         data-video-embed="http://www.twitch.tv/<?= Config::$a['twitch']['user'] ?>/popout"
         data-chat-embed="/embed/chat">
        ...
        <div class="panelheader clearfix">
            <div class="toolgroup clearfix">
                ...
                <div class="btn-group pull-right">
                    <a id="popoutchat" title="Pop-out chat" href="/embed/chat" class="btn btn-xs btn-link">Pop-out
                        chat</a>
                    <a id="popoutvideo" title="Pop-out video" href="http://www.twitch.tv/destiny/popout"
                       class="btn btn-xs btn-link">Pop-out stream</a>
                </div>
            </div>
        </div>
        <div id="player-embed">
