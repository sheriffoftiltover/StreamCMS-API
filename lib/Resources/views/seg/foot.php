...
<section id="footer" class="container">
    <footer class="clearfix">
        ...
        <p class="pull-right" style="text-align: right;">
            ...
            <br>Source code for <a href="https://github.com/destinygg/website">website</a> and <a
                    href="https://github.com/destinygg/chat">chat</a> @ <a
                    href="https://github.com/destinygg">Github</a>
        </p>
    </footer>
</section>