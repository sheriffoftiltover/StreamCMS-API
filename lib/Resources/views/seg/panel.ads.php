                    ...
                    <div class="donate-block" id="paypal-donation">
                        ...
                        <div id="paypal-form">
                            <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                ...
                                <input type="hidden" name="currency_code" value="USD"> <input type="hidden" name="bn"
                                                                                              value="PP-DonationsBF:btn_donateCC_LG.gif:NonHostedGuest">
                                <button class="btn btn-lg btn-paypal"
                                        title="PayPal - The safer, easier way to pay online!">Contribute
                                </button>
                ...
                <div style="width: 60%; float: left;">
                    <div class="private-ads">
                        ...
                        <div class="private-ad" id="ting">
                            <img height="1" width="1" src="http://ting.7eer.net/i/72409/87559/2020" border="0"
                                 style="position: absolute; top:0; left:0;"/>
                            <a href="http://ting.7eer.net/c/72409/87559/2020"
                               style="background-color: #00a3e0; margin: 0 auto; overflow: hidden; height:250px;"><img
                                        src="http://adn.impactradius.com/display-ad/2020-87559" border="0" alt=""
                                        width="250" height="250"/></a>
                        </div>
                        <div class="private-ad" id="dollar-shave-club">
                            <a href="http://Dollar-Shave-Club.7eer.net/c/72409/74122/1969"><img
                                        src="http://adn.impactradius.com/display-ad/1969-74122" border="0"
                                        alt="DollarShaveClub-Shave Time Shave Money" width="300" height="250"/></a>
                            <img height="1" width="1" src="http://Dollar-Shave-Club.7eer.net/i/72409/74122/1969"
                                 border="0"/>
                        </div>
                    </div>
                </div>
