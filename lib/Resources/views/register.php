...
<section class="container">
    ...
    <h1 class="title">
        <span>Confirm</span>
        <small>your <i
                    class="icon-<?= Tpl::out($model->authProvider) ?>"></i> <?= Tpl::out(strtolower($model->authProvider)) ?>
            details</small>
    </h1>
    ...
    <div class="content content-dark clearfix">
        ...
        <div class="ds-block">
            <p>Almost there... since not all authentication providers support nick names, you get to choose your own.
                <br>Your email address is never shown publically and no emails will be sent to you without your
                permission.
            </p>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" class="form-control" name="username" id="inputUsername"
                               value="<?= Tpl::out($model->username) ?>" placeholder="Username">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" class="form-control" name="email" id="inputEmail"
                               value="<?= Tpl::out($model->email) ?>" placeholder="Email">
                ...
                <div class="form-group">
                    <div class="controls">
                        <label class="checkbox">
                            <input type="checkbox" name="rememberme" <?= ($model->rememberme) ? 'checked' : '' ?>>
                            Remember my login
                        </label>
