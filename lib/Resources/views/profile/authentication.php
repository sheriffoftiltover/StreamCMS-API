...
<section class="container collapsible active">
    ...
    <div class="content content-dark clearfix">
        <div class="ds-block">
            <p>Authentication providers are what we use to know who you are! you can login with any of the services
                below</p>
        </div>
...
<section class="container collapsible active">
    ...
    <div class="content content-dark clearfix">
        <div class="ds-block">
            <p>Login keys allow you to authenticate with the destiny.gg chat without the need for a username or
                password. Keys MUST be kept a <strong>confidential</strong>.</p>
        </div>
            ...
            <table class="grid" style="width:100%">
                ...
                <?php if (!empty($model->authTokens)): ?>
                    <?php foreach ($model->authTokens as $authToken): ?>
                        <tr>
                            <td><a href="/profile/authtoken/<?= $authToken['authToken'] ?>/delete"
                                   class="btn btn-danger btn-xs">Delete</a> <span><?= $authToken['authToken'] ?></span>
                            </td>
