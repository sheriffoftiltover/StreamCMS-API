        ...
        <?php if (!$model->subscriptionCancelled): ?>
            <form action="/subscription/cancel" method="post" autocomplete="off">
                ...
                <input type="hidden" name="subscriptionId"
                       value="<?= Tpl::out($model->subscription['subscriptionId']) ?>"/>

                <div class="ds-block">
                    <div class="form-group">
                        <label class="label label-danger">WARNING</label> Cancelling an active subscription can only be
                            ...
                            <dd>
                                ...
                                <?php if ($model->subscription['recurring']): ?>
                                    <span class="label label-warning"
                                          title="This subscription is automatically renewed">Recurring</span>
                                <?php endif; ?>
                            </dd>
                    ...
                    <div class="form-group">
                        <label class="checkbox">
                            <input name="cancelRemainingTime" type="checkbox" value="1"/> Cancel the remaining
                            subscription time <em>immediately</em>
                        </label>
                    </div>
