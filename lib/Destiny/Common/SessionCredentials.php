...
class SessionCredentials
{
    ...
    {
        return ['email' => $this->getEmail(), 'username' => $this->getUserName(), 'userId' => $this->getUserId(), 'userStatus' => $this->getUserStatus(), 'country' => $this->getCountry(), 'roles' => $this->getRoles(), 'authProvider' => $this->getAuthProvider(), 'features' => $this->getFeatures()];
    }
