...
class RegistrationController
{
    ...
    public function registerProcess(array $params, ViewModel $model)
    {
        ...
        try {
            ...
            $userService->addUserAuthProfile(['userId' => $user ['userId'], 'authProvider' => $authCreds->getAuthProvider(), 'authId' => $authCreds->getAuthId(), 'authCode' => $authCreds->getAuthCode(), 'authDetail' => $authCreds->getAuthDetail()]);
