...
class IpnController
{
    ...
    public function ipn(array $params)
    {
        ...
        try {
            ...
            $orderService->addIPNRecord(['ipnTrackId' => $data ['ipn_track_id'], 'ipnTransactionId' => $data ['txn_id'], 'ipnTransactionType' => $data ['txn_type'], 'ipnData' => json_encode($data, JSON_UNESCAPED_UNICODE)]);
