...
class UserAdminController
{
    ...
    public function adminUserEditProcess(array $params, ViewModel $model)
    {
        ...
        // Data for update
        $userData = ['username' => $username, 'country' => $country, 'email' => $email];
    ...
    public function subscriptionAdd(array $params, ViewModel $model)
    {
        ...
        $model->subscription = ['subscriptionType' => '', 'createdDate' => gmdate('Y-m-d H:i:s'), 'endDate' => gmdate('Y-m-d H:i:s'), 'status' => 'Active', 'recurring' => false];
